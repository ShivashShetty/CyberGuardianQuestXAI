...
const allPuzzles: Puzzle[] = [
  ...
  { scrambled: "yprecoitn", answer: "encryption", hint: "Scrambling data so only authorized parties can understand the information." },
  { scrambled: "svriatniu", answer: "antivirus", hint: "Software that protects your computer from viruses." },
  ...
  { scrambled: "utitlivlnaerb", answer: "vulnerability", hint: "A weakness in a system that can be attacked." },
  ...
  { scrambled: "dtaa ebrhc", answer: "data breach", hint: "When sensitive information is stolen or exposed." },
  ...
  { scrambled: "rsuiv", answer: "virus", hint: "A piece of code that is capable of copying itself and typically has a detrimental effect." },
